...
public interface XinshengMapper {
    ...
    @Delete("DELETE from tb_xinsheng where  name=#{name} and xuehao=#{xuehao} and banji=#{banji}")
    void delete( @Param("name") String name, @Param("xuehao") String xuehao, @Param("banji") String banji);
