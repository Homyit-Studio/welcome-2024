...
<template>
    <div class="background">
     ...
     c-40.79,
                1.98-85.04,
                2.97-122.48,
                2.97s-81.69-1-122.48-2.97c-20.39-0.99-40.78-2.32-61.1-4.29c-20.3-2.02-40.62-4.42-60.48-8.99 l-0.42,
                1.67c19.92,
                5.04,
                40.25,
                9.5,
                ...
                0,
                81.89-1.88,
                122.74-4.75c20.42-1.43,
                40.83-3.22,
                61.16-5.63c20.32-2.47,
                40.65-6.92,
                60.57-11.97L519.05,
                43.86z" />
     ...
     l0.22,
                1.39c18.88-2.59,
                37.89-4.14,
                56.92-5.05c19.03-0.91,
                34.61-0.87,
                57.82-0.87s38.79-0.04,
                57.82,
                0.87 c19.03,
                0.92,
                38.04,
     ...
     c-0.24-0.33-0.48-0.67-0.73-0.98l-0.71-0.77c-1.93-1.96-3.7-3.02-5.41-4C539.34,
                18.67,
                444.21,
                0,
                275,
                ...
                275,
                980s140.6-9.38,
                168.15-21.69c10.31-4.61,
                17.31-14.45,
                18.52-25.69 l6.73-62.36l7.75-73.93l7.76-73.93l7.57-73.95L499,
                574.5l7.37-73.97l7.37-73.97l7.19-73.99l7.16-73.99c2.4-24.66,
                4.74-49.33,
                7-74.01 c4.57-49.35,
                9.06-98.73,
                13.02-148.18l1.47-18.54l0.37-4.63l0.05-0.58C550.01,
                32.21,
                550,
                31.52,
                549.97,
                ...
                6.05-58.46,
                10.27-92.61,
                10.27s-68.29-4.22-92.61-10.27c-16.16-4.02-28.38-17.22-31.19-33.64 c-1.32-7.69-2.41-15.02-3.42-22.87c-1.46-11.4-9.1-21.06-19.84-25.18c-32.48-12.46-42.82-22.82-44.15-38.94h0l-3.39-41.09 l-6.11-74.08l-6.31-74.07l-6.36-74.06l-6.51-74.05l-6.51-74.05l-6.66-74.03l-13.3-148.05c-4.45-49.35-8.83-98.68-12.66-148.04 l-1.42-18.52l-0.29-3.8c0.39-0.31,
                0.96-0.69,
                1.59-1.05c1-0.57,
                2.2-1.12,
                3.43-1.65c5.05-2.08,
                10.86-3.66,
                16.67-5.03 c5.84-1.38,
                11.81-2.52,
                17.81-3.56c12.03-2.02,
                24.18-3.78,
                36.39-5.25c12.21-1.5,
                24.48-2.66,
                36.76-3.85 C176.07,
                8.05,
                226.65,
        ...
        <div class="instructions"><br />点击倒酒</div>
    </div>
</template>
...
.background {
    padding-top: 60px;
    background-color: rgba(15, 11, 11, 0.414);
    width: 40%;
}
...
.glass .beer {
    ...
    animation-name: fill;
    background-image: url('../../assets/zhangxuelong/beer.png');
...
.glass .bubbles .layer {
    ...
    background-image: url('../../assets/zhangxuelong//bubbles.png');
